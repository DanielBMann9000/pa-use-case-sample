        ...
        public AboutPage()
        {
            ...
            Label label = new Label
            {
                Text =
                    ...
                    Environment.NewLine + "The resulting telemetry is transmitted to a PreEmptive Analytics™ endpoint where it is ingested and processed using the PreEmptive Analytics Workbench and PreEmptive Analytics for TFS." +
